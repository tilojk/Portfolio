...
export default function Imprint() {
  return (
    <div className="container px-8 lg:px-12 xl:px-24 2xl:px-36 m-auto">
      ...
      <div>
        <h2 className="text-2xl 3xl:text-3xl mb-4 3xl:mb-6">Angaben gemäß § 5 TMG</h2>
        ...
        <h2 className="text-2xl 3xl:text-3xl mb-4 3xl:mb-6">Kontakt</h2>
        <p className="text-base 3xl:text-lg mb-6 3xl:mb-8">
        ...
        <h2 className="text-2xl 3xl:text-3xl mb-4 3xl:mb-6">Bild- und Icon-Credits</h2>
        <p className="text-base 3xl:text-lg mb-6 3xl:mb-8">
        ...
        <h2 className="text-2xl 3xl:text-3xl mb-4 3xl:mb-6">Haftungsausschluss</h2>
        <p className="text-base 3xl:text-lg mb-16">
